...
/**
 * AST representation off a lower-equal comparison
 */
public final class LEQExpr extends BinExpr {

    /**
     * Creates a new LEQExpr
     * 
     * @param left
     *            left subexpression
     * @param right
     ...
     */
    public LEQExpr(final Expr left, final Expr right,
