...
/**
 * AST representation off a division
 */
public final class DIVTerm extends BinExpr {

    /**
     * Creates a new DIVTerm
     * 
     * @param left
     *            left subexpression
     * @param right
     ...
     */
    public DIVTerm(final Expr left, final Expr right, final String file, final int line) {
